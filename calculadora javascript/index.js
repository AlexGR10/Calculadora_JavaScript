...
function borraruno() {
    ...
    var memoriaop = toString(document.getElementById("resultado").value);

    var operandos = memoriaop.split("");
    operandos.length = operandos.length - 1
    var resultado = memoriaop.length;
    document.getElementById("resultado").value = resultado;
}
